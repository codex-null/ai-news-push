...
def sparkline(history: list[float], color: str) -> str:
    ...
    return f'<svg class="sparkline" viewBox="0 0 {width} {height}" role="img" aria-label="价格走势"><polygon points="{area}" fill="{color}" opacity=".12"/><polyline points="{points_text}" fill="none" stroke="{color}" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>'
